...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityUltimateOscillator : IEquatable<ApiResponseSecurityUltimateOscillator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityUltimateOscillator(List<UltimateOscillatorTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityUltimateOscillator);
        }
