...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ZacksLongTermGrowthRate : IEquatable<ZacksLongTermGrowthRate>, IValidatableObject
    {
        /// <summary>
        ...
        public ZacksLongTermGrowthRate(decimal? Mean = default, decimal? Median = default, int? Count = default, decimal? High = default, decimal? Low = default, string StdDev = default, int? RevisionsUpward = default, int? RevisionsDownward = default, string Mean7DaysAgo = default, string Mean30DaysAgo = default, string Mean60DaysAgo = default, string Mean90DaysAgo = default, string RevisionsUpwardLast7Days = default, string RevisionsDownwardLast7Days = default, string RevisionsUpwardLast30Days = default, string RevisionsDownwardLast30Days = default, string RevisionsUpwardLast60Days = default, string RevisionsDownwardLast60Days = default, string RevisionsUpwardLast90Days = default, string RevisionsDownwardLast90Days = default, string RevisionsUpwardLast120Days = default, string RevisionsDownwardLast120Days = default, string RevisionsUpwardLast150Days = default, string RevisionsDownwardLast150Days = default, SecuritySummary Security = default)
        {
            this.Mean = Mean;
            this.Median = Median;
            this.Count = Count;
        ...
        {
            return Equals(obj as ZacksLongTermGrowthRate);
        }
