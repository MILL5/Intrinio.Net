...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ZacksEpsSurprise : IEquatable<ZacksEpsSurprise>, IValidatableObject
    {
        /// <summary>
        ...
        public ZacksEpsSurprise(string Id = default, decimal? FiscalYear = default, string FiscalQuarter = default, decimal? CalendarYear = default, string CalendarQuarter = default, DateTime? ActualReportedDate = default, string ActualReportedTime = default, string ActualReportedCode = default, string ActualReportedDesc = default, decimal? EpsActual = default, decimal? EpsActualZacksAdj = default, decimal? EpsMeanEstimate = default, decimal? EpsAmountDiff = default, decimal? EpsPercentDiff = default, decimal? EpsCountEstimate = default, decimal? EpsStdDevEstimate = default, SecuritySummary Security = default)
        {
            this.Id = Id;
        ...
        {
            return Equals(obj as ZacksEpsSurprise);
        }
