...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityDonchianChannel : IEquatable<ApiResponseSecurityDonchianChannel>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityDonchianChannel(List<DonchianChannelTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityDonchianChannel);
        }
