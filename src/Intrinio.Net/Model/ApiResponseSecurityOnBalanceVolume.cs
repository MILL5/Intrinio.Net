...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityOnBalanceVolume : IEquatable<ApiResponseSecurityOnBalanceVolume>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityOnBalanceVolume(List<OnBalanceVolumeTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityOnBalanceVolume);
        }
