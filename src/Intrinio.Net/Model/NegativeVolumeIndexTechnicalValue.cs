...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class NegativeVolumeIndexTechnicalValue : IEquatable<NegativeVolumeIndexTechnicalValue>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(obj as NegativeVolumeIndexTechnicalValue);
        }
