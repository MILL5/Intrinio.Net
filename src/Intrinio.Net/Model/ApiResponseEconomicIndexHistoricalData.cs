...
namespace Intrinio.Net.Model
{
    ...
    public sealed partial class ApiResponseEconomicIndexHistoricalData : IEquatable<ApiResponseEconomicIndexHistoricalData>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="other">Instance of ApiResponseEconomicIndexHistoricalData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseEconomicIndexHistoricalData other)
        {
            if (other == null)
                return false;
