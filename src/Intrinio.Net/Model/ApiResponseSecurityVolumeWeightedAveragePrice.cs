...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityVolumeWeightedAveragePrice : IEquatable<ApiResponseSecurityVolumeWeightedAveragePrice>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityVolumeWeightedAveragePrice(List<VolumeWeightedAveragePriceValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityVolumeWeightedAveragePrice);
        }
