...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityBollingerBands : IEquatable<ApiResponseSecurityBollingerBands>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityBollingerBands(List<BollingerBandsTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityBollingerBands);
        }
