...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class StockMarketIndexSummary : IEquatable<StockMarketIndexSummary>, IValidatableObject
    {
        /// <summary>
        ...
        public StockMarketIndexSummary(string Id = default, string Symbol = default, string Name = default, string Continent = default, string Country = default, string UpdateFrequency = default, DateTime? LastUpdated = default, DateTime? ObservationStart = default, DateTime? ObservationEnd = default)
        {
            this.Id = Id;
            this.Symbol = Symbol;
            this.Name = Name;
        ...
        {
            return Equals(obj as StockMarketIndexSummary);
        }
