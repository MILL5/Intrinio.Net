...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityKeltnerChannel : IEquatable<ApiResponseSecurityKeltnerChannel>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityKeltnerChannel(List<KeltnerChannelTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityKeltnerChannel);
        }
