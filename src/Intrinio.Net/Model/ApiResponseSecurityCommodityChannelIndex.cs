...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityCommodityChannelIndex : IEquatable<ApiResponseSecurityCommodityChannelIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityCommodityChannelIndex(List<CommodityChannelIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityCommodityChannelIndex);
        }
