...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecuritySimpleMovingAverage : IEquatable<ApiResponseSecuritySimpleMovingAverage>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecuritySimpleMovingAverage(List<SimpleMovingAverageTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecuritySimpleMovingAverage);
        }
