...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityKnowSureThing : IEquatable<ApiResponseSecurityKnowSureThing>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityKnowSureThing(List<KnowSureThingTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityKnowSureThing);
        }
