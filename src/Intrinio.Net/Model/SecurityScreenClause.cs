...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class SecurityScreenClause : IEquatable<SecurityScreenClause>, IValidatableObject
    {
        /// <summary>
        ...
        public SecurityScreenClause(string Field = default, LogicOperator? Operator = default, string Value = default)
        {
            this.Field = Field;
        ...
        {
            return Equals(obj as SecurityScreenClause);
        }
