...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseStockExchangeRealtimeStockPrices : IEquatable<ApiResponseStockExchangeRealtimeStockPrices>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseStockExchangeRealtimeStockPrices(List<RealtimeStockPrice> StockPrices = default, StockExchange StockExchange = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseStockExchangeRealtimeStockPrices);
        }
