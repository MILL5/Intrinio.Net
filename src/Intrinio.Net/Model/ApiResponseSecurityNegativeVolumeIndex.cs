...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityNegativeVolumeIndex : IEquatable<ApiResponseSecurityNegativeVolumeIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityNegativeVolumeIndex(List<NegativeVolumeIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityNegativeVolumeIndex);
        }
