...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityMoneyFlowIndex : IEquatable<ApiResponseSecurityMoneyFlowIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityMoneyFlowIndex(List<MoneyFlowIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityMoneyFlowIndex);
        }
