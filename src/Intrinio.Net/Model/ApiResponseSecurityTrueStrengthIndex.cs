...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityTrueStrengthIndex : IEquatable<ApiResponseSecurityTrueStrengthIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityTrueStrengthIndex(List<TrueStrengthIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityTrueStrengthIndex);
        }
