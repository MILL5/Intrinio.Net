...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityAverageDailyTradingVolume : IEquatable<ApiResponseSecurityAverageDailyTradingVolume>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityAverageDailyTradingVolume(List<AverageDailyTradingVolumeTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityAverageDailyTradingVolume);
        }
