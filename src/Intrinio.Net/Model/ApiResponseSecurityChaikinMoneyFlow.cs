...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityChaikinMoneyFlow : IEquatable<ApiResponseSecurityChaikinMoneyFlow>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityChaikinMoneyFlow(List<ChaikinMoneyFlowTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityChaikinMoneyFlow);
        }
