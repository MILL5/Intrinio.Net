...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityForceIndex : IEquatable<ApiResponseSecurityForceIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityForceIndex(List<ForceIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityForceIndex);
        }
