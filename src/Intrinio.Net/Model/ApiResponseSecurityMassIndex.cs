...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityMassIndex : IEquatable<ApiResponseSecurityMassIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityMassIndex(List<MassIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityMassIndex);
        }
