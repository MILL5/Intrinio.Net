...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityAccumulationDistributionIndex : IEquatable<ApiResponseSecurityAccumulationDistributionIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityAccumulationDistributionIndex(List<AccumulationDistributionIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityAccumulationDistributionIndex);
        }
