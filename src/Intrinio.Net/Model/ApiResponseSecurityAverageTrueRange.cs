...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityAverageTrueRange : IEquatable<ApiResponseSecurityAverageTrueRange>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityAverageTrueRange(List<AverageTrueRangeTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityAverageTrueRange);
        }
