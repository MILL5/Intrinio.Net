...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityAwesomeOscillator : IEquatable<ApiResponseSecurityAwesomeOscillator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityAwesomeOscillator(List<AwesomeOscillatorTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityAwesomeOscillator);
        }
