...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityWilliamsR : IEquatable<ApiResponseSecurityWilliamsR>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityWilliamsR(List<WilliamsRTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityWilliamsR);
        }
