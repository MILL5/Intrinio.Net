...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityVortexIndicator : IEquatable<ApiResponseSecurityVortexIndicator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityVortexIndicator(List<VortexIndicatorTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityVortexIndicator);
        }
