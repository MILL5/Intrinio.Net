...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityEaseOfMovement : IEquatable<ApiResponseSecurityEaseOfMovement>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityEaseOfMovement(List<EaseOfMovementTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityEaseOfMovement);
        }
