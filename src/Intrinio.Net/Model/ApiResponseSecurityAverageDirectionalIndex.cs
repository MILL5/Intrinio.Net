...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityAverageDirectionalIndex : IEquatable<ApiResponseSecurityAverageDirectionalIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityAverageDirectionalIndex(List<AverageDirectionalIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityAverageDirectionalIndex);
        }
