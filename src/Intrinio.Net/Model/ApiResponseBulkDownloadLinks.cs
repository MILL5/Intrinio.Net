...
namespace Intrinio.Net.Model
{
    ...
    public sealed partial class ApiResponseBulkDownloadLinks : IEquatable<ApiResponseBulkDownloadLinks>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="other">Instance of ApiResponseBulkDownloadLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseBulkDownloadLinks other)
        {
            if (other == null)
                return false;
            ...
            return
                (
                    BulkDownloads == other.BulkDownloads ||
                    BulkDownloads != null &&
                    BulkDownloads.SequenceEqual(other.BulkDownloads)
                );
        }
