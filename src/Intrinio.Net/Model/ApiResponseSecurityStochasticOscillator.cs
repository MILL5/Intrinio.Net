...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityStochasticOscillator : IEquatable<ApiResponseSecurityStochasticOscillator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityStochasticOscillator(List<StochasticOscillatorTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityStochasticOscillator);
        }
