...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class EconomicIndex : IEquatable<EconomicIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public EconomicIndex(string Id = default, string Symbol = default, string Name = default, string Continent = default, string Country = default, string UpdateFrequency = default, DateTime? LastUpdated = default, string Description = default, DateTime? ObservationStart = default, DateTime? ObservationEnd = default, string SeasonalAdjustment = default, string Units = default)
        {
            this.Id = Id;
            this.Symbol = Symbol;
            this.Name = Name;
        ...
        {
            return Equals(obj as EconomicIndex);
        }
