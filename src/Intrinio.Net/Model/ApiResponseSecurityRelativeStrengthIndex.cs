...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityRelativeStrengthIndex : IEquatable<ApiResponseSecurityRelativeStrengthIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityRelativeStrengthIndex(List<RelativeStrengthIndexTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityRelativeStrengthIndex);
        }
