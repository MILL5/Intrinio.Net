...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityDetrendedPriceOscillator : IEquatable<ApiResponseSecurityDetrendedPriceOscillator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityDetrendedPriceOscillator(List<DetrendedPriceOscillatorTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityDetrendedPriceOscillator);
        }
