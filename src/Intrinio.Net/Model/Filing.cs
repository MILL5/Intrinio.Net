...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class Filing : IEquatable<Filing>, IValidatableObject
    {
        /// <summary>
        ...
        public Filing(string Id = default, DateTime? FilingDate = default, DateTime? AcceptedDate = default, DateTime? PeriodEndDate = default, string ReportType = default, string SecUniqueId = default, string FilingUrl = default, string ReportUrl = default, string InstanceUrl = default, string IndustryCategory = default, string IndustryGroup = default, int? WordCount = default, CompanySummary Company = default)
        {
            this.Id = Id;
