...
namespace Intrinio.Net.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed partial class ApiResponseSecurityIchimokuKinkoHyo : IEquatable<ApiResponseSecurityIchimokuKinkoHyo>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityIchimokuKinkoHyo(List<IchimokuKinkoHyoTechnicalValue> Technicals = default, TechnicalIndicator Indicator = default, SecuritySummary Security = default, string NextPage = default)
        {
        ...
        {
            return Equals(obj as ApiResponseSecurityIchimokuKinkoHyo);
        }
